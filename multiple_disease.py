...
import sys
sys.path.insert(1, "C:\\Users\\Nishant Haasan\\Desktop\\Premnath\\multiple_disease_prediction-master\\multiple_disease_prediction-master\\streamlit_option_menu")
from streamlit_option_menu import option_menu


#loading the models

diabetes = pickle.load(open("C:\\Users\\Nishant Haasan\\Desktop\\Premnath\\multiple_disease_prediction-master\\multiple_disease_prediction-master\\models\\diabetes_model.sav", "rb"))

heart_disease = pickle.load(open("C:\\Users\\Nishant Haasan\\Desktop\\Premnath\\multiple_disease_prediction-master\\multiple_disease_prediction-master\\models\\heart_disease_model.sav", "rb"))

parkinsons_disease = pickle.load(open("C:\\Users\\Nishant Haasan\\Desktop\\Premnath\\multiple_disease_prediction-master\\multiple_disease_prediction-master\\models\\parkinsons_disease_model.sav", "rb"))

breast_cancer = pickle.load(open("C:\\Users\\Nishant Haasan\\Desktop\\Premnath\\multiple_disease_prediction-master\\multiple_disease_prediction-master\\models\\breast_cancer_model.sav", "rb"))

lung_cancer = pickle.load(open("C:\\Users\\Nishant Haasan\\Desktop\\Premnath\\multiple_disease_prediction-master\\multiple_disease_prediction-master\\models\\lung_cancer_model.sav", "rb"))
